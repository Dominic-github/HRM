...
namespace HRM.View
{
    public partial class SoftwareUser : Form
    {
        ...
        private void SoftwareUser_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (isLogout)
            {
                LogoutTime = DateTime.Now;
        ...
        private void SoftwareUser_Paint(object sender, PaintEventArgs e)
        {
